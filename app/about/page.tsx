    ...
    <div className="flex flex-col items-center justify-between lg:flex-row py-16">
      ...
      <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
        ...
        <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
          <Image  src="/images/aboutImage.png" alt='AboutImage'         width={500}
        height={500}/>
        </div>
      </div>
    </div>
        ...
        height={500}
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <Link
                  href="/about/#"
                  className="inline-flex items-center justify-center py-3 text-base font-medium text-center text-white border border-transparent rounded-md px-7 bg-green-500 hover:bg-opacity-90"
                >
                  Get Started
                </Link>
              </div>
