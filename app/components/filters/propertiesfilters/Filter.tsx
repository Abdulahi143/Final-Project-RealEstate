...
const PropertiesFilterSection = () => {
  ...
  return (
    <div className="md:ml-32 lg:ml-[450px] sm:place-items-center pt-8 max-w-screen-md justify-center ">
...
export default PropertiesFilterSection;
