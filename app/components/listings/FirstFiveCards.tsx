...
const FirstFiveCards: React.FC<FirstFiveCardProps> = ({
  data,
  reservation,
  onAction,
  disabled,
      ...
      >
        ...
        "
          ...
          >
            ...
            <div className="flex flex-row justify-start items-center gap-1 lg:gap-4 mt-2">
