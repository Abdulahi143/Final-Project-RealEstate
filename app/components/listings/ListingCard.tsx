...
const furnished = (furnished: string) => {
  ...
  return (
    ...
    className="col-span-1 cursor-pointer group hover:shadow-lg border border-gray-300 rounded-lg w-full sm:max-w-lg"
  >
      ...
      <div className='p-3 flex flex-col gap-2 w-full'>
        ...
        <div className='flex items-center gap-1'>
          ...
          <p className='text-sm text-gray-600 truncate w-full'>
            {location?.label}, {location?.region} {/* Adjusted to use location data */}
          </p>
        </div>
